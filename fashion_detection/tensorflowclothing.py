...
# Names of the labels indicies (0-9)
...
model = keras.Sequential([
    # Flatten the 28x28 images to a linear data set
    keras.layers.Flatten(input_shape=(28, 28)),
    keras.layers.Dense(128, activation=tf.nn.relu),  # 128 neurons on top
    keras.layers.Dense(10, activation=tf.nn.softmax),  # 10 neurons on bottom
])
...
# See the accuracy of the model on the test data set
test_loss, test_acc = model.evaluate(test_images, test_labels)
print("Test Accuracy", test_acc)

# Predict every image with the model
